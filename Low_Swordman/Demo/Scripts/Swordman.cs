...
public class Swordman : PlayerController
{
    ...
    private void OnTriggerEnter2D(Collider2D col)
    {
        ...
        switch (col.tag)
        {
            case "Portal": personagem.transform.position = pontoFinal.transform.position;
                break;


            case "inimigo": m_Anim.Play("Die");
                break;
        }
    ...
    private void OnCollisionStay2D(Collision2D col)
    {
        ...
        if (col.gameObject.tag == "plataformaMovel" && m_MoveX == 0) // se entrar na plataforma e estiver parado, objeto vira filho desse objeto
        {
